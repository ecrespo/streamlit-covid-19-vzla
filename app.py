...
st.title(f" Covid-19 data {option}" )
st.write(df[df["Country/Region"] == option][selects].tail(1))
st.write(f"## {option}")

st.line_chart(df[df["Country/Region"] == option][selects])
...
if option == "Venezuela":
    ...
    filename1 = "bystate_historic.csv"
    ...
    filename2 = "Covid-19 confirmed cases by age and gender.csv"
